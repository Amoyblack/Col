...
if not ns.L then 
	print "---RsPlates: The addon can't adapt for your client language (it will shows in english now), if you want to get localization support. Please send email to flyoverrs@outlook.com"
	ns.L = {
	    MenuBasis = "Basis",
